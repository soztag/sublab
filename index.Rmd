...
```{r dependency-management, eval = FALSE, echo=FALSE}
# only run this periodically, and only on local machine
# cannot work on travis, apparently
library(checkpoint)
checkpoint(snapshotDate = "2017-02-06", 
           use.knitr = TRUE, 
...
# set knitr options ====
knitr::opts_knit$set(root.dir = normalizePath(getwd()))  # make sure the knitr path is correct
knitr::opts_chunk$set(tidy = TRUE, cache = TRUE, echo = FALSE, warning = FALSE, message = FALSE)  # tidy formats code nicely in echo
