...
german <- concourse$german
names(german) <- concourse$handle
german <- psItemContent(items = german, lang = "de-DE")
english <- concourse$english
names(english) <- concourse$handle
english <- psItemContent(items = english, lang = "en-US")
```
